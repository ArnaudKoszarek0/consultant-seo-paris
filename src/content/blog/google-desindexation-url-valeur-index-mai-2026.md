---
title: "Google désindexe plus vite : le vrai problème, c'est la valeur par URL"
description: "Depuis avril 2026, des SEO observent plus de désindexations Google. Le sujet n'est pas seulement technique : chaque URL doit prouver sa valeur."
date: "2026-05-02"
tags: ["seo", "actualite"]
---
...
1. Exporter les URL passées de « indexée » à « exclue » dans Search Console, sur 90 jours.
2. Croiser avec les logs serveur : Googlebot continue-t-il de crawler ces URL ?
3. Croiser avec les clics et impressions sur 16 mois. Une page sans demande n'est pas toujours une perte SEO.
4. Mesurer la profondeur de clic. Une page à 5 clics de la home ne peut pas se plaindre d'être ignorée.
5. Classer les URL en trois groupes : **à renforcer**, **à fusionner**, **à supprimer**.
